<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="申请人" prop="contestants">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['apply:progress:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['apply:progress:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['apply:progress:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="applyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="比赛简介" align="center" prop="competitionDesc" />
      <el-table-column label="申请人" align="center" prop="contestants" />
     <!-- <el-table-column label="作品简介" align="center" prop="introduction" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="比赛简介" prop="competitionDesc">
          <el-input v-model="form.competitionDesc" placeholder="请输入比赛简介" />
        </el-form-item>
        <el-form-item label="申请人" prop="contestants">
          <el-input v-model="form.contestants" placeholder="请输入申请人" />
        </el-form-item>
        <el-form-item label="阶段任务" prop="introduction">
