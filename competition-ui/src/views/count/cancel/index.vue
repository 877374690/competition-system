<template>
  <div class="app-container">
    <div id="chartBar" style="width:600px;height:600px;margin:0 auto"></div>
...
<script>
  import {listCheck, getOnline, delOnline, addOnline, updateOnline,listCancel} from "@/api/manage/online";
    ...
    methods: {
      ...
      getList() {
        ...
        listCancel(this.queryParams).then(response => {
          ...
          this.loading = false;
          let xData = this.onlineList.map(item=>item.competitionType)
          let yData = this.onlineList.map(item=>item.competitionName)
